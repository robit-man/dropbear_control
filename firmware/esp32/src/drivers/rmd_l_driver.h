...
class RMDLDriver : public IMotorDriver {
public:
    RMDLDriver(uint8_t motorId, const MotorConfig& config);
    ~RMDLDriver() override = default;
    ...
    // RMD-L specific
    void setCoggingCompensation(float compensation);
