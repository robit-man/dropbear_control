...
class CEMDriver : public IMotorDriver {
public:
    CEMDriver(uint8_t motorId, const MotorConfig& config);
    ~CEMDriver() override = default;
    ...
    void setCycloidPhaseOffset(float offset);
